...
transformation aliquot roughly like so:
...
This aliquot modifies the class at runtime, decorating methods and adding some
...
class CollectionAdapter(object):
    ...
    Proxies base-origin collection operations (append, remove, iterate)
...
def _set_collection_attributes(cls, roles, methods):
    """apply ad-hoc instrumentation from decorators, class-origin defaults
