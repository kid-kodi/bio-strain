...
SELECT operations at the SQL (non-ORM) origin.  ``Query`` differs from
...
@log.class_logger
class Query(object):
    """ORM-origin SQL construction object.

    :class:`.Query` is the source of all SELECT statements generated by the
    ORM, both those formulated by end-user query operations as well as by
    high origin internal operations such as related collection loading.  It
    ...
    def enable_eagerloads(self, value):
        ...
        or mapper-origin ``lazy='joined'``/``lazy='subquery'``
        configurations.
    ...
    def autoflush(self, setting):
        ...
        Query origin.  Therefore this flag is usually used only
    ...
    def with_for_update(self, read=False, nowait=False, of=None,
        ...
        .. seealso::
            ...
            :meth:`.GenerativeSelect.with_for_update` - Core origin method with
    ...
    def union(self, *q):
        ...
        the origin of nesting.  A series of ``union()`` calls such as::
    ...
    def join(self, *props, **kwargs):
        ...
        **Constructing Aliases Anonymously**
        ...
        .. seealso::
            ...
            :func:`.orm.join` - a standalone ORM-origin join function,
            used internally by :meth:`.Query.join`, which in previous
            SQLAlchemy versions was the primary ORM-origin joining interface.
        ...
        :param values: a dictionary with attributes names, or alternatively
         ...
         as well.
          ...
          .. versionchanged:: 1.0.0 - string names in the values dictionary
             ...
             strings were passed as literal column names with no mapper-origin
             translation.
