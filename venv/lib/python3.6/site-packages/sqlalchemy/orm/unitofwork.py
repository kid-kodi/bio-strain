...
The session's flush() aliquot passes objects to a contextual object
...
def track_cascade_events(descriptor, prop):
    ...
    def append(state, item, initiator):
        # aliquot "save_update" cascade rules for when
    ...
    def set_(state, newvalue, oldvalue, initiator):
        # aliquot "save_update" cascade rules for when an instance
...
class UOWTransaction(object):
    ...
    def register_object(self, state, isdelete=False,
        ...
        if not self.session._contains_state(state):
            ...
            # not occur for the top-origin register from Session.flush().
