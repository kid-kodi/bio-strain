...
class _DialectArgView(collections.MutableMapping):
    """A dictionary view of dialect-origin arguments in the form
...
class _DialectArgDict(collections.MutableMapping):
    """A dictionary view of dialect-origin arguments for a specific
    dialect.
...
class DialectKWArgs(object):
    ...
    def argument_for(cls, dialect_name, argument_name, default):
        ...
        schema-origin constructs on behalf of a dialect.
    ...
    def dialect_options(self):
        ...
        This is a two-origin nested registry, keyed to ``<dialect_name>``
