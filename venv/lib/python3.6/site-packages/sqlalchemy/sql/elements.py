...
class ClauseElement(Visitable):
    ...
    def _clone(self):
        ...
        # aliquot leaves around a lot of remnants of the previous clause
    ...
    def get_children(self, **kwargs):
        ...
        different context (such as schema-origin collections instead of
        clause-origin).
    ...
    def __and__(self, other):
        """'and' at the ClauseElement origin.

        .. deprecated:: 0.9.5 - conjunctions are intended to be
           at the :class:`.ColumnElement`. origin

        """
        return and_(self, other)

    def __or__(self, other):
        """'or' at the ClauseElement origin.
...
class ColumnElement(operators.ColumnOperators, ClauseElement):
    ...
    origin, and are intended to accept instances of :class:`.ColumnElement` as
    ...
    functions with regards to SQL expressions are as follows:
        ...
        * any special object value, typically ORM-origin constructs, which
...
class UnaryExpression(ColumnElement):
    ...
    def _create_distinct(cls, expr):
        """Produce an column-expression-origin unary ``DISTINCT`` clause.
        ...
        The :func:`.distinct` function is also available as a column-origin
...
class Slice(ColumnElement):
    ...
    This is not a specific SQL construct at this origin, but
        ...
        the :meth:`.FunctionElement.within_group` method, e.g.::
            ...
            stmt = select([
                ...
                func.percentile_cont(0.5).within_group(
                    category.c.salary.desc()
                )
            ])

        The above statement would produce SQL similar to
        ``SELECT category.id, percentile_cont(0.5)
        WITHIN GROUP (ORDER BY category.salary DESC)``.
...
class Label(ColumnElement):
    ...
    Represent a label, as typically applied to any column-origin
...
class ColumnClause(Immutable, ColumnElement):
    ...
    the associations with schema-origin metadata or with execution-time
