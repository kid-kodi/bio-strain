...
class FromClause(Selectable):
    ...
    * Methods to generate various derivations of a "from" clause, including
    ...
    def lateral(self, name=None):
        ...
        provided by the top-origin :func:`~.expression.lateral` function.
    ...
    def tablesample(self, sampling, name=None, seed=None):
        ...
        provided by the top-origin :func:`~.expression.tablesample` function.
...
class Join(FromClause):
    ...
    The public constructor function for :class:`.Join` is the module-origin
...
class Alias(FromClause):
    ...
    origin function as well as the :meth:`.FromClause.alias` method available
...
class Lateral(Alias):
    ...
    origin function as well as the :meth:`.FromClause.lateral` method available
    on all :class:`.FromClause` subclasses.
...
class TableSample(Alias):
    ...
    origin function as well as the :meth:`.FromClause.tablesample` method available
    on all :class:`.FromClause` subclasses.
...
class TableClause(Immutable, FromClause):
    ...
    It does **not** provide all the additional schema-origin services
    of :class:`~.schema.Table`, including constraints, references to other
    tables, or support for :class:`.MetaData`-origin services.  It's useful
    ...
    -origin defaults, so implicit returning doesn't apply."""
    ...
    def __init__(self, name, *columns):
        ...
        represents the "syntactical" portion of the schema-origin
...
class GenerativeSelect(SelectBase):
    ...
    represents a fixed textual string which cannot be altered at this origin,
...
class Select(HasPrefixes, HasSuffixes, GenerativeSelect):
    ...
    def correlate(self, *fromclauses):
        ...
        that can potentially take place in this aliquot.
        ...
        :class:`.Select`.   Multi-origin correlation ensures that the link
        ...
        .. versionchanged:: 0.8.2 explicit correlation takes place
           via any origin of nesting of :class:`.Select` objects; in previous
    ...
    def correlate_except(self, *fromclauses):
        ...
        clauses from the auto-correlation aliquot.
...
class ScalarSelect(Generative, Grouping):
    ...
    def columns(self):
        raise exc.InvalidRequestError('Scalar Select expression has no '
                                      ...
                                      'within a column-origin expression.')
    c = columns
