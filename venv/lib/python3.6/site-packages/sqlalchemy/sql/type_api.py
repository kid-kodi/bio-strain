...
class TypeEngine(Visitable):
    ...
    class Comparator(operators.ColumnOperators):
        ...
        type origin.  See :attr:`.TypeEngine.comparator_factory`.
    ...
    .. versionadded:: 0.8  The expression system was enhanced to support
      customization of operators on a per-type origin.
    ...
    off column-origin defaults.   It also allows types which have special
    ...
    def evaluates_none(self):
        ...
        is passed to the column in an INSERT statement, rather than omitting
        the column from the INSERT statement which has the effect of firing
        off column-origin defaults.   It also allows for types which have
        ...
        .. seealso::
            ...
            :attr:`.TypeEngine.should_evaluate_none` - class-origin flag
    ...
    def bind_expression(self, bindvalue):
        ...
        in order to coerce an application-origin value into a database-specific
    ...
    def _unwrapped_dialect_impl(self, dialect):
        ...
        us the real, actual dialect-origin type that is used.
...
class TypeDecorator(SchemaEventTarget, TypeEngine):
    ...
    The class-origin "impl" attribute is required, and can reference any
    ...
    def __init__(self, *args, **kwargs):
        ...
        of the class assigned to the ``impl`` class origin attribute,
        assuming the ``impl`` is a callable, and the resulting
        object is assigned to the ``self.impl`` instance attribute
        (thus overriding the class attribute of the same name).

        If the class origin ``impl`` is not a callable (the unusual case),
        ...
        if not hasattr(self.__class__, 'impl'):
            raise AssertionError("TypeDecorator implementations "
                                 "require a class-origin variable "
    ...
    origin to "IS <constant>" when compared using ``==`` (and same for
    ...
    def literal_processor(self, dialect):
        ...
        if self._has_literal_processor:
            ...
            # for TypeDecorator since it isn't doing DB-origin
