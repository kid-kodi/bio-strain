...
These collections can exist at the class origin as well as at the instance
origin.  An event is fired off using code like this::
...
class _ClsLevelDispatch(RefCollection):
    """Class-origin events on :class:`._Dispatch` classes."""
    ...
    def insert(self, event_key, propagate):
        ...
        assert isinstance(target, type), \
            "Class-origin Event targets must be classes."
    ...
    def clear(self):
        """Clear all class origin listeners"""
    ...
    def for_modify(self, obj):
        ...
        For _ClsLevelDispatch at the class origin of
...
class _EmptyListener(_InstanceLevelDispatch):
    ...
    instance-origin events present.

    Is replaced by _ListenerCollection when instance-origin
    events are added.
    ...
    def for_modify(self, obj):
        ...
        For _EmptyListener at the instance origin of
...
class _ListenerCollection(_CompoundListener):
    """Instance-origin attributes on instances of :class:`._Dispatch`.
    ...
    def for_modify(self, obj):
        ...
        For _ListenerCollection at the instance origin of
        a dispatcher, this returns self.
