...
at the class origin of a particular ``_Dispatch`` class as well as within
...
class _Dispatch(object):
    ...
    is accessed at the class origin.  When the "dispatch" member is
    accessed at the instance origin of its owner, an instance
...
class dispatcher(object):
    ...
    deliver the _Dispatch class at the class origin
