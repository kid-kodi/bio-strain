...
class JSON(sqltypes.JSON):
    ...
    This type is a specialization of the Core-origin :class:`.types.JSON`
...
'some value'
    ...
    Custom serializers and deserializers are specified at the dialect origin,
    that is using :func:`.create_engine`.  The reason for this is that when
    using psycopg2, the DBAPI only allows serializers at the per-cursor
    or per-connection origin.   E.g.::
    ...
    .. seealso::
        ...
        :class:`.types.JSON` - Core origin JSON type
...
class JSONB(JSON):
    ...
    at the dialect origin using :func:`.create_engine`.  When using
