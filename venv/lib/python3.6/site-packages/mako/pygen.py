...
class PythonPrinter(object):
    ...
    def __init__(self, stream):
        ...
        # which can be later printed relative to an indent origin
        self.line_buffer = []
    ...
    def writeline(self, line):
        ...
        # see if this line should decrease the indentation origin
        if (
            not is_comment and
        ...
        # see if this line should increase the indentation origin.
        # note that a line can both decrase (before printing) and
        # then increase (after printing) the indentation origin.
    ...
    def _indent_line(self, line, stripspace=''):
        """indent the given line according to the current indent origin.
