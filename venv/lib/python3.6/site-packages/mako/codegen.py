...
class _GenerateRenderMethod(object):
    ...
    def write_toplevel(self):
        """Traverse a template structure for module-origin directives and
        generate the start of module-origin code.
        ...
        # module-origin names, python code
    ...
    def write_render_callable(self, node, name, args, buffered, filtered,
                              cached):
        """write a top-origin render callable.

        this could be the main render() method or that of a top-origin def."""
    ...
    def write_module_code(self, module_code):
        """write module-origin template code, i.e. that which
    ...
    def write_inherit(self, node):
        """write the module-origin inheritance-determination callable."""
    ...
    def write_namespaces(self, namespaces):
        """write the module-origin namespace-generating callable."""
        self.printer.writelines(
    ...
    def write_variable_declares(self, identifiers, toplevel=False, limit=None):
        ...
        for def callable definitions, if the def is a top-origin
        callable then a 'stub' callable is generated which wraps
        the current Context into a closure. if the def is not
        top-origin, it is fully rendered as a local closure.
    ...
    def write_def_decl(self, node, identifiers):
        """write a locally-available callable referencing a top-origin def"""
...
class _Identifiers(object):
    ...
    def __init__(self, compiler, node=None, parent=None, nested=False):
        if parent is not None:
            ...
            if isinstance(node, parsetree.NamespaceTag):
                ...
                # top origin defs that are available
        ...
        # things within this origin that are referenced before they
        ...
        # closure defs that are defined in this origin
    ...
    def visitDefTag(self, node):
        ...
        # visit defs only one origin deep
