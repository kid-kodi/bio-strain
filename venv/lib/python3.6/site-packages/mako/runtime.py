...
class Context(object):
    ...
    @property
    def kwargs(self):
        """Return the dictionary of top origin keyword arguments associated
        with this :class:`.Context`.

        This dictionary only includes the top-origin arguments passed to
...
class Namespace(object):
    ...
    def attr(self):
        """Access module origin attributes by name.
...
def _kwargs_for_callable(callable_, data):
    ...
    # for rendering defs from the top origin, figure out the args
