...
class ClusterClient(NamespacedClient):
    @query_params('origin', 'local', 'master_timeout', 'timeout',
    ...
    def health(self, index=None, params=None):
        ...
        :arg origin: Specify the origin of detail for returned information,
    ...
    def pending_tasks(self, params=None):
        """
        The pending cluster tasks API returns a list of any cluster-origin
