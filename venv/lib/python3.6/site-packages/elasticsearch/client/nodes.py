...
class NodesClient(NamespacedClient):
    ...
    @query_params('completion_fields', 'fielddata_fields', 'fields', 'groups',
        'include_segment_file_sizes', 'origin', 'timeout', 'types')
    def stats(self, node_id=None, metric=None, index_metric=None, params=None):
        ...
        :arg origin: Return indices stats aggregated at index, node or shard
            origin, default 'node', valid choices are: 'indices', 'node',
            'shards'
        :arg timeout: Explicit operation timeout
