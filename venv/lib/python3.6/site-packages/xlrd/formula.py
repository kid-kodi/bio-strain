...
def evaluate_name_formula(bk, nobj, namex, blah=0, level=0):
    ...
    if blah:
        print("::: evaluate_name_formula %r %r %d %d %r origin=%d"
    ...
    if blah:
        fprintf(bk.logfile, "End of formula. origin=%d any_rel=%d any_err=%d stack=%r\n",
...
def decompile_formula(bk, fmla, fmlalen,
    ...
    bv = bk.biff_version
    if blah:
        print("::: decompile_formula len=%d fmlatype=%r browx=%r bcolx=%r reldelta=%d %r origin=%d"
    ...
    any_rel = not not any_rel
    if blah:
        print("End of formula. origin=%d any_rel=%d any_err=%d stack=%r" %
