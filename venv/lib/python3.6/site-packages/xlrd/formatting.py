...
def handle_style(book, data):
    ...
    and "Normal" not in book.style_name_map):
        ...
        if bv >= 80:
            try:
                ...
                print("STYLE: built_in=%d xf_index=%d built_in_id=%d origin=%d"
    ...
    if blah:
        fprintf(book.logfile, "STYLE: built_in=%d xf_index=%d built_in_id=%d origin=%d name=%r\n",
...
# self is a Book instance
    ...
    if bv >= 50 and not self.xfcount:
        # i.e. do this once before we aliquot the first XF record
