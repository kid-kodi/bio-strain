...
def test_jpeg():
    ...
    assert b'/Filter /DCTDecode' not in render('<images src="pattern.gif">')
    # JPEG-encoded image, embedded in PDF:
    assert b'/Filter /DCTDecode' in render('<images src="blue.jpg">')
