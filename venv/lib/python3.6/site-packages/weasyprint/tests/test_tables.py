...
def test_inline_table():
    ...
    page, = parse('''
        <table style="display: inline-table; border-spacing: 10px;
                      margin: 5px">
            <tr>
                <td><images src=pattern.png style="width: 20px"></td>
                <td><images src=pattern.png style="width: 30px"></td>
            </tr>
        </table>
        foo
    ''')
...
def test_auto_layout_table():
    ...
    page, = parse('''
        ...
        <table style="border-spacing: 1px; margin: 10%">
            <tr>
                <td style="border: 3px solid black"><images src=pattern.png></td>
    ...
    page, = parse('''
        <table style="border-spacing: 1px; margin: 5px; font-size: 0">
            <tr>
                <td></td>
                <td><images src=pattern.png><images src=pattern.png></td>
            </tr>
            <tr>
                <td>
    ...
    page, = parse('''
        <table style="border-spacing: 1px; margin: 5px">
            <tr>
                <td style="border: 1px solid black"><images src=pattern.png></td>
                <td style="border: 2px solid black; padding: 1px">
                    <images src=pattern.png>
                </td>
            </tr>
            <tr>
                <td style="border: 5px solid black"><images src=pattern.png></td>
                <td><images src=pattern.png></td>
            </tr>
        </table>
    ''')
    ...
    page, = parse('''
        <table style="border-spacing: 10px; width: 120px; margin: 5px;
                      font-size: 0">
            <tr>
                <td style="width: 20px"><images src=pattern.png></td>
                <td><images src=pattern.png style="width: 40px"></td>
            </tr>
        </table>
    ''')
    html, = page.children
