...
def test_block_heights():
    ...
    page, = parse('''
        ...
        <div>
          <images src=pattern.png style="height: 40px">
        </div>
        <div style="height: 10%">
          <images src=pattern.png style="height: 40px">
        </div>
...
def test_page_breaks():
    ...
    pages = parse('''
        <style>
            @page { size: 100px; margin: 10px }
            images { height: 30px; display: block }
        </style>
        <body>
            <images src=pattern.png>
            <images src=pattern.png>
            <images src=pattern.png>
            <images src=pattern.png>
            <images src=pattern.png>
    ...
    for page in pages:
        ...
        assert all([img.element_tag == 'images' for img in images])
    ...
    page_1, page_2 = parse('''
        <style>
            ...
            images { height: 25px; vertical-align: top }
            p { orphans: 1; widows: 1 }
        </style>
        <body>
            <images src=pattern.png>
            <div>
                <p><images src=pattern.png><br/><images src=pattern.png><p>
                <p><images src=pattern.png><br/><images src=pattern.png><p>
            </div><!-- page break here -->
            <images src=pattern.png>
    ''')
    ...
    page_1, page_2 = parse('''
        ...
        <body>
            <images src=pattern.png><!-- page break here -->
            <div>
                <p style="page-break-inside: avoid">
                    ><images src=pattern.png><br/><images src=pattern.png></p>
    ...
    page_1, page_2, page_3 = parse('''
        ...
        <body>
            <div>
                <images src=pattern.png style="page-break-after: always">
                <section>
                    <images src=pattern.png>
                    <images src=pattern.png>
                </section>
    ...
    page_1, page_2, page_3 = parse('''
        ...
        <body>
            <div>
                ...
                <section>
                    <images src=pattern.png><!-- page break here -->
                    <images src=pattern.png style="page-break-after: avoid">
                </section>
            </div>
            <images src=pattern.png style="page-break-after: avoid">
            <images src=pattern.png>
...
def test_images():
    ...
    body, img = get_img('<images src="%s">' % url)
    assert img.width == 96
    ...
    for url in [
        ...
        with capture_logs() as logs:
            body, img = get_img("<images src='%s' alt='invalid image'>" % url)
        assert len(logs) == 1
    ...
    with capture_logs() as logs:
        parse('<images src=nonexistent.png><images src=nonexistent.png>')
    ...
    body, img = get_img('''<body style="font-size: 0">
        <images src="pattern.png" style="width: 40px">''')
    ...
    body, img = get_img('''<body style="font-size: 0"><p style="width: 200px">
        <images src="pattern.png" style="width: 20%">''')
    assert body.height == 40
    assert img.position_y == 0
    assert img.width == 40
    assert img.height == 40
    ...
    body, img = get_img('''<body style="font-size: 0">
        <images src="pattern.png" style="min-width: 40px">''')
    assert body.height == 40
    assert img.position_y == 0
    assert img.width == 40
    assert img.height == 40

    body, img = get_img('<images src="pattern.png" style="max-width: 2px">')
    assert img.width == 2
    assert img.height == 2
    ...
    page, = parse('''<body style="font-size: 0">
        <images src="pattern.png" style="width: 40px">
        <images src="pattern.png" style="width: 60px; display: table-cell">
    ''')
    html, = page.children
    body, = html.children
    line, = body.children
    ...
    page, = parse('''
        <style>
            @page { size: 100px }
            images { width: 40px; margin: 10px auto; display: block }
        </style>
        <body>
            <images src="pattern.png">
    ''')
    ...
    page, = parse('''
        <style>
            @page { size: 100px }
            images { min-width: 40%; margin: 10px auto; display: block }
        </style>
        <body>
            <images src="pattern.png">
    ''')
    ...
    page, = parse('''
        <style>
            @page { size: 100px }
            images { min-width: 40px; margin: 10px auto; display: block }
        </style>
        <body>
            <images src="pattern.png">
    ''')
    ...
    page, = parse('''
        <style>
            @page { size: 100px }
            images { min-height: 30px; max-width: 2px;
    ...
    page, = parse('''
        ...
        <images style="height: 200px; margin: 10px; display: block" src="
            data:image/svg+xml,
...
def test_vertical_align():
    ...
    page, = parse('''
        <span>
            <images src="pattern.png" style="width: 40px"
            ><images src="pattern.png" style="width: 60px"
        ></span>''')
    html, = page.children
    body, = html.children
    line, = body.children
    ...
    page, = parse('''
        <span>
            <images src="pattern.png" style="width: 40px; vertical-align: -15px"
            ><images src="pattern.png" style="width: 60px"></span>''')
    html, = page.children
    body, = html.children
    line, = body.children
    span, = line.children
    ...
    page, = parse('''
        <span style="line-height: 10px">
            <images src="pattern.png" style="width: 40px; vertical-align: -150%"
            ><images src="pattern.png" style="width: 60px"></span>''')
    html, = page.children
    body, = html.children
    line, = body.children
    ...
    page, = parse('''
        <span style="line-height: 10px">
            <span style="line-height: 10px; vertical-align: -15px">
                <images src="pattern.png" style="width: 40px"></span>
            <images src="pattern.png" style="width: 60px"></span>''')
    html, = page.children
    body, = html.children
    line, = body.children
    ...
    page, = parse('''
        <span style="line-height: 12px; font-size: 12px; font-family: 'ahem'">
            <images src="pattern.png" style="width: 40px; vertical-align: middle"
            ><images src="pattern.png" style="width: 60px"></span>''')
    html, = page.children
    body, = html.children
    line, = body.children
    ...
    page, = parse('''
        <span style="line-height: 10px">
            <images src="pattern.png" style="width: 60px"
            ><images src="pattern.png" style="width: 40px; vertical-align: super"
            ><images src="pattern.png" style="width: 40px; vertical-align: sub"
        ></span>''')
    html, = page.children
    body, = html.children
    line, = body.children
    ...
    page, = parse('''
        <body style="line-height: 10px">
            <span>
                <images src="pattern.png" style="vertical-align: text-top"
                ><images src="pattern.png" style="vertical-align: text-bottom"
            ></span>''')
    html, = page.children
    body, = html.children
    line, = body.children
    ...
    page, = parse('''
        <span style="font-size: 0">
            <images src="pattern.png" style="vertical-align: 26px">
            <images src="pattern.png" style="vertical-align: -10px">
            <span style="vertical-align: top">
                <images src="pattern.png" style="vertical-align: -10px">
                <span style="vertical-align: -10px">
                    <images src="pattern.png" style="vertical-align: bottom">
                </span>
            </span>
            <span style="vertical-align: bottom">
                <images src="pattern.png" style="vertical-align: 6px">
            </span>
        </span>''')
    html, = page.children
    body, = html.children
    ...
    page, = parse('''
        <span style="font-size: 0">
            <images src="pattern.png" style="vertical-align: bottom">
            <images src="pattern.png" style="vertical-align: top; height: 100px">
        </span>
    ''')
    html, = page.children
    body, = html.children
    ...
    assert img_1.element_tag == 'images'
    assert img_1.position_y == 0
...
def test_inline_replaced_auto_margins():
    ...
    page, = parse('''
        <style>
            @page { size: 200px }
            images { display: inline; margin: auto; width: 50px }
        </style>
        <body><images src="pattern.png" />''')
    html, = page.children
    body, = html.children
    line, = body.children
    img, = line.children
...
def test_relative_positioning():
    ...
    page, = parse('''
        ...
        <body>
        <span><images src=pattern.png></span>
        <span style="position: relative; left: 10px">
            ...
            <images src=pattern.png style="position: relative">
            <images src=pattern.png>
        </span>
        <span><images src=pattern.png></span>
    ''')
...
def test_absolute_positioning():
    ...
    page, = parse('''
        <style> images { width: 5px; height: 20px} </style>
        <body style="font-size: 0">
            <images src=pattern.png>
            <span style="position: absolute">2</span>
            <images src=pattern.png>
...
def test_absolute_images():
    page, = parse('''
        <style>
            images { display: block; position: absolute }
        </style>
        <div style="margin: 10px">
            <images src=pattern.png />
            <images src=pattern.png style="left: 15px" />
        </div>
    ''')
    html, = page.children
    body, = html.children
...
def test_box_decoration_break():
    ...
    page_1, page_2 = parse('''
        <style>
            ...
            images { height: 40px; vertical-align: top }
        </style>
        <p>
            <images src=pattern.png><br>
            <images src=pattern.png><br>
            <images src=pattern.png><br>
            <images src=pattern.png><br>''')
    html, = page_1.children
