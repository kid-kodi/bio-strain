...
def test_floats():
    ...
    page, = parse('''
        <style>
            div { float: left }
            images { width: 100px; vertical-align: top }
        </style>
    ...
    page, = parse('''
        <style>
            ...
            images { width: 60px; vertical-align: top }
        </style>
        <div><images src=pattern.png /><!-- 1 --></div>
        <div><images src=pattern.png /><!-- 2 --></div>
        <div><images src=pattern.png /><!-- 4 --></div>
        <images src=pattern.png /><!-- 3
        --><images src=pattern.png /><!-- 5 -->''')
    html, = page.children
    body, = html.children
    ...
    page, = parse('''
        ...
        <p style="width: 100%"></p>
        <images src=pattern.png /><images src=pattern.png />
    ''')
    html, = page.children
    body, = html.children
    ...
    page, = parse('''
        ...
        <body>
        <span>
            <images src=pattern.png style="width: 50px" />
            <images src=pattern.png style="width: 50px" />
            <images src=pattern.png style="float: left; width: 30px" />
        </span>
    ''')
    html, = page.children
    body, = html.children
...
def test_floats_page_breaks():
    ...
    pages = parse('''
        <style>
            ...
            images { height: 45px; width:70px; float: left;}
        </style>
        <body>
    ...
    page_images = []
    for page in pages:
        images = [d for d in page.descendants() if d.element_tag == 'images']
    ...
    pages = parse('''
        <style>
            @page { size: 100px; margin: 10px }
            images { height: 81px; width:70px; float: left;}
        </style>
        <body>
            <images src=pattern.png>
                    <!-- page break should be here !!! -->
    ...
    pages = parse('''
        <style>
            @page { size: 100px; margin: 10px }
            images { height: 30px; width:70px; float: left;}
        </style>
        <body>
            <images src=pattern.png>
            <images src=pattern.png>
...
def test_preferred_widths():
    ...
    page, = parse('''
        <style>images { width: 20px }</style>
        <p style="float: left">
            <images src=pattern.png><images src=pattern.png><br>
            <images src=pattern.png></p>
    ''')
    html, = page.children
    body, = html.children
    paragraph, = body.children
