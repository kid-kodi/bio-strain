...
def test_text_align_justify():
    ...
    page, = parse('''
        ...
        <p><images src="pattern.png" style="width: 40px">
            <strong>
                <images src="pattern.png" style="width: 60px">
                <images src="pattern.png" style="width: 10px">
                <images src="pattern.png" style="width: 100px"
            ></strong><images src="pattern.png" style="width: 290px"
