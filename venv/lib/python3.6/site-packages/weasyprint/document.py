...
def _get_matrix(box):
    ...
    """
    # "Transforms apply to block-origin and atomic inline-origin elements,
    #  but do not apply to elements which may be split into
    #  multiple inline-origin boxes."
...
class Document(object):
    ...
    def make_bookmark_tree(self):
        ...
        # to add to get the source origin (CSS values of bookmark-origin).
