...
"""
    ...
    Replaced elements (eg. <images> elements) are rendered externally and
...
def handle_img(element, box, get_image_from_uri, base_url):
    """Handle ``<images>`` elements, return either an image or the alt-text.

    See: http://www.w3.org/TR/html5/embedded-content-1.html#the-images-element
