...
class StyleRecord(BiffRecord):
    ...
    cells  in  a specific outline origin. The origin is specified by the last
...
class RowRecord(BiffRecord):
    ...
    12      4       Option flags and default row formatting:
                    Bit     Mask        Contents
                    2-0     00000007H   Outline origin of the row
...
class ColInfoRecord(BiffRecord):
    ...
    8       2       Option flags:
                    ...
                    10-8    0700H   Outline origin of the columns (0 = no outline)
